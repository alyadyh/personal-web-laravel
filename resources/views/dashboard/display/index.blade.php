...
<body data-spy="scroll" data-target="#pb-navbar" data-offset="200">
	...
	<section class="site-hero" style="background-image: url({{ asset('website') }}/images/background.png);" id="section-home" data-stellar-background-ratio="0.5">
		<div class="container">
		...
		<div class="container">
			...
			<div class="filters">
				<ul>
					...
					<li data-filter=".packaging">Web</li>
					<li data-filter=".mockup">Design</li>
					<li data-filter=".typography">Photography</li>
					<li data-filter=".photography">Other</li>
				</ul>
			</div>
				...
				<div class="row grid">
					...
					<div class="single-portfolio col-sm-4 all mockup">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{ asset('website') }}/images/p2.jpg" alt="">
							</div>
							<a href="{{ asset('website') }}/images/p2.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="{{ asset('website') }}/images/preview.png" alt=""></div>
								</div>
							</a>                                  
					...
					<div class="single-portfolio col-sm-4 all packaging">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{ asset('website') }}/images/p3.jpg" alt="">
							</div>
							<a href="{{ asset('website') }}/images/p3.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="{{ asset('website') }}/images/preview.png" alt=""></div>
								</div>
							</a> 
					...
					<div class="single-portfolio col-sm-4 all packaging">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{ asset('website') }}/images/p4.jpg" alt="">
							</div>
							<a href="{{ asset('website') }}/images/p4.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="{{ asset('website') }}/images/preview.png" alt=""></div>
								</div>
							</a>                                
					...
					<div class="single-portfolio col-sm-4 all typography">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{ asset('website') }}/images/p5.jpg" alt="">
							</div>
							<a href="{{ asset('website') }}/images/p5.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="{{ asset('website') }}/images/preview.png" alt=""></div>
								</div>
							</a>                                
					...
					<div class="single-portfolio col-sm-4 all photography">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="{{ asset('website') }}/images/p6.jpg" alt="">
							</div>
							<a href="{{ asset('website') }}/images/p6.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="{{ asset('website') }}/images/preview.png" alt=""></div>
								</div>
							</a>                                
	...
	<section class="site-section" id="section-about">
		<div class="container">
			<div class="row mb-5 align-items-center">
				<div class="col-lg-5 pr-lg-4 mb-5 mb-lg-0">
					<img src="{{ asset('website') }}/images/foto1.png" alt="Image placeholder" class="img-fluid">
				</div>
				<div class="col-lg-5 pl-lg-5">
					...
					<p>
						<a href="#section-contact" class="btn btn-primary mr-3 px-4 py-2 btn-sm smoothscroll">Hire Me</a>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						<div class="block-47-image">
							<img src="{{ asset('website') }}/images/person_1.jpg" alt="Image placeholder" class="img-fluid">
						</div>
				...
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						<div class="block-47-image">
							<img src="{{ asset('website') }}/images/person_2.jpg" alt="Image placeholder" class="img-fluid">
						</div>
						<blockquote class="block-47-quote">
							<p>&ldquo;Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.&rdquo;</p>
				...
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						<div class="block-47-image">
							<img src="{{ asset('website') }}/images/person_3.jpg" alt="Image placeholder" class="img-fluid">
						</div>
						<blockquote class="block-47-quote">
							<p>&ldquo;Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.&rdquo;</p>
							<cite class="block-47-quote-author">&mdash; Ethan McCown, CEO <a href="#">XYZ Inc.</a></cite>
				...
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						<div class="block-47-image">
							<img src="{{ asset('website') }}/images/person_4.jpg" alt="Image placeholder" class="img-fluid">
						</div>
						<blockquote class="block-47-quote">
							<p>&ldquo;Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.&rdquo;</p>
							<cite class="block-47-quote-author">&mdash; Craig Gowen, CEO <a href="#">XYZ Inc.</a></cite>
			...
			<div class="row">
				<div class="col-sm-6 col-lg-4 mb-4">
					<div class="blog-entry">
						<a href="#"><img src="{{ asset('website') }}/images/post_1.jpg" alt="Image placeholder" class="img-fluid"></a>
				...
				<div class="col-sm-6 col-lg-4 mb-4">
					<div class="blog-entry">
						<a href="#"><img src="{{ asset('website') }}/images/post_2.jpg" alt="Image placeholder" class="img-fluid"></a>
						<div class="blog-entry-text">
							<h3><a href="#">Creative Product Designer From Facebook</a></h3>
							<p class="mb-4">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
				...
				<div class="col-sm-6 col-lg-4 mb-4">
					<div class="blog-entry">
						<a href="#"><img src="{{ asset('website') }}/images/post_3.jpg" alt="Image placeholder" class="img-fluid"></a>
						<div class="blog-entry-text">
							<h3><a href="#">Creative Product Designer From Facebook</a></h3>
							<p class="mb-4">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
	...
	<script src="{{ asset('website') }}/js/vendor/jquery-migrate-3.0.1.min.js"></script>
	<script src="{{ asset('website') }}/js/vendor/popper.min.js"></script>
	<script src="{{ asset('website') }}/js/vendor/bootstrap.min.js"></script>

	<script src="{{ asset('website') }}/js/vendor/jquery.easing.1.3.js"></script>

	<script src="{{ asset('website') }}/js/vendor/jquery.stellar.min.js"></script>
	<script src="{{ asset('website') }}/js/vendor/jquery.waypoints.min.js"></script>
